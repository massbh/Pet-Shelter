...
<body>
    ...
    <div class="blog-form-container">
        <div class="blog-form-header">
            <h1><i data-lucide="plus-circle"></i> Create New Blog Post</h1>
            <p style="color: #666; margin-top: 0.5rem;">Share stories, tips, and updates about your pet shelter</p>
        </div>
        ...
        <form action="{{ route('admin.blog.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="blog-form-actions">
                ...
                <button type="submit" class="btn-submit">
                    <i data-lucide="save"></i> Create Post
                </button>
            </div>
        </form>
    </div>
