    ...
    <body>
            ...
            <div class="contact-content">
                ...
                <div class="contact-form-section">
                    ...
                    <form id="contactForm" class="contact-form">
                        ...
                        <!-- Adoption Visit Schedule (Hidden by default) -->
                        <div id="visitSchedule" class="visit-schedule hidden">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" required placeholder="Tell us how we can help you (max 500 characters)" maxlength="500"></textarea>
                ...
                <div class="contact-info-section">
                    ...
                    <div class="contact-method">
                        <h3>✉️ Email</h3>
                        <p>General: info@happinest.org<br>
                           Adoptions: adopt@happinest.org</p>
                    </div>
        ...
        <script>
            ...
            function showConfirmation() {
                ...
                // Show visit details if adoption was selected
