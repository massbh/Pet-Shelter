...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest wherePetId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereMessage($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereAdminNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<AdoptionRequest>|AdoptionRequest query()
     ...
     */
    class AdoptionRequest extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read int|null $adoptionRequests_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Pet>|Pet whereSpecies($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pet>|Pet whereAge($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pet>|Pet whereSex($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pet>|Pet whereImageUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pet>|Pet whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Pet>|Pet whereStatus($value)
